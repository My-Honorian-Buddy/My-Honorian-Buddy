    ...
    <div class="flex-1">
            ...
            <div class="relative text-center space-y-6">
                <h1 class="relative z-30 font-bold leading-snug text-center">
                    <div class="bg-primary shadow-custom-button px-2 border-2 border-black mb-6 rounded-full mt-5">
                        <p class="text-[58px] px-5 py-3 text-accent2"
                            style="-webkit-text-stroke: 2px black; -webkit-text-fill-color: currentColor;">
                            MATCHMAKING RESULTS
                        </p>
                    </div>
            </div>
                            ...
                            <section class="flex  mt-8 justify-center w-full">
                                ...
                                <div
                                    ...
                                    <div class="p-4">
                                        {{-- content --}}
                                        <div
                                            class="flex flex-row md:flex-row sm:flex-col w-full items-center px-4 py-4">
                                            {{-- column 1 --}}
                                            <div
                                                class="flex flex-col justify-center items-center md:-mt-4 md:w-[25%] sm:mt-5">
                                                {{-- profile image --}}
                                                <div
                                                    class="flex h-40 w-40 justify-center shrink-0 items-center  space-x-4 p-1">
                                            ...
                                            <div class="ml-5 w-[75%] mt-5 p-1">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="font-bold text-[30px] -mt-2">
                                                        {{ $user->tutor->fname }} {{ $user->tutor->lname }}</p>

                                                    {{-- yr level and college program --}}
                                                    <p class="font-bold text-primary text-[16px]">Year Level and
                                                        College Program</p>
                                                    <p class="font-bold text-[22px] -mt-1">
                                                        {{ $user->tutor->year_level }}
                                                        {{ $user->tutor->department }} </p>

                                                    {{-- subject expertise --}}
                                                    <p class="font-bold text-primary text-[16px]">Subject Expertise
                                                    </p>
                                                            ...
                                                            <div
                                                                ...
                                                                @else
                                                                    <div
                                                                        ...
                                                                        <p class="font-bold text-[18px]">No
                                                            ...
                                                            <div class="flex w-full">
                                                                ...
                                                                <div class="w-full">
                                                                    <p class="font-bold text-primary text-[16px]">
                                                                        Experience</p>
                                                                    <div
                                                                        class="flex justify-start space-x-4 -mt-1 -ml-5 mb-2">
                                                                        <div
                                                                ...
                                                                <div class="w-full sm:w-[70%]">
                                                                    ...
                                                                    @if ($user->tutor->NoOfReviews > 0)
                                                                        @foreach ($reviews as $review)
                                                                            <div
                                                                                class="flex gap-6 items-center w-full mt-2">
                                                                                <p
                                                                                    class="font-bold text-primary text-[16px]">
                                                                                    {{ number_format($review->where('tutor_id', $user->tutor->user_id)->avg('rating') ?? 0, 1) }}
                                                                                </p>
                                                                                <x-bladewind.rating class="w-full"
        ...
        <div class="flex justify-center items-center mt-12">
            <div class="font-bold font-poppins text-gray-500 mt-8 mb-8 text-[18px]">
                Couldn't find the buddy you wanted? Try <a href="{{ route('tutor.search') }}"><u>Manual
                        Searching.</u></a>
            </div>
        </div>
