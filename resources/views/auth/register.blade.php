            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <x-text-input id="password" 
                        ...
                        required 
                        autocomplete="off" />
                    <button type="button" onclick="togglePasswordVisibility('password', 'eyeIcon')" class="absolute right-3 top-1/2 translate-y-[-50%] mt-1 text-gray-600 hover:text-primary transition-colors flex items-center justify-center">
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <x-text-input id="password_confirmation" 
                        ...
                        required 
                        autocomplete="off" />
                    <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'eyeIconConfirm')" class="absolute right-3 top-1/2 translate-y-[-50%] mt-1 text-gray-600 hover:text-primary transition-colors flex items-center justify-center">
