        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4 sm:space-y-5">
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    ...
                    <button type="button" onclick="togglePasswordVisibility('password', 'eyeIcon')" class="absolute right-3 top-1/2 translate-y-[-50%] mt-1 text-darkgray hover:text-primary transition-colors flex items-center justify-center">
