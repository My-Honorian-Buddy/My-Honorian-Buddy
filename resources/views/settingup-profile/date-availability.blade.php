    ...
    <x-folder class="h-auto md:h-full">
        ...
        <x-slot name="content">
            ...
            <div class="flex flex-row justify-center items-center md:w-3/4 mx-auto pt-4 space-x-20">
                ...
                <!--FORM-->
                <form method="POST" class="w-full md:w-1/2 flex flex-col justify-center"
                    action="{{ route('user.schedule.store') }}">
                    @csrf
                    ...
                    <div class="py-3">
                        <div class="font-poppins text-black">
                            ...
                            <div class="flex space-x-2 flex-row justify-center gap-2 mb-2">
                                <!-- Monday-->
                                <div
                                    class="bg-accent3 my-3 py-[6px] rounded-full border-2 border-gray-300 hover:bg-primary/5 duration-200
                                    hover:border-primary/70 text-primary text-[16px] text-center font-bold cursor-pointer sm:w-[160px]">
                                    <label class="w-full h-full cursor-pointer flex items-center">
                                        <input type="checkbox" class="hidden peer" name="days_week[]" id="monday"
                                            value="Monday">
                                        <span
                                            class="w-5 h-5 bg-gray-300 border-2 border-black rounded-full peer-checked:bg-primary peer-checked:border-primary transition-colors duration-200 ml-2"></span>
                        ...
                        <div class="font-poppins text-black">
                                        ...
                                        <label class="w-full h-full cursor-pointer flex items-center">
                                            ...
                                            <span
                                                class="w-5 h-5 bg-gray-300 border-2 border-black rounded-full peer-checked:bg-primary
                                                 peer-checked:border-primary transition-colors duration-200 ml-2"></span>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-col w-full mb-10 md:mb-20 mt-10 md:-mt-0">
                                    <label for="time-from"
                                        class="font-bold font-poppins text-xl md:text-2xl mt-1 mb-1">Time</label>
                                    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-1">
                                        ...
                                        <div class=" w-full">
                                            ...
                                            <input type="time" id="start_time" name="start_time"
                                                class="border-2 font-semibold font-poppins text-2xl text-darkgray text-center rounded-lg border-gray-300
                                                bg-accent outline-none duration-200 ring-2 ring-[transparent] focus:ring-primary/70 w-full h-12"
                                                required>
                                        </div>
