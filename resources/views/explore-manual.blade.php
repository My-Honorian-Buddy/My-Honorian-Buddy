...
<div class="flex-1">
        ...
        <div class="flex h-auto w-full justify-center items-center mt-10 ">
        <div class="grid grid-cols-3 gap-6">
            @for ($i = 0; $i < 9; $i++)
                <div class="transition-transform duration-300 hover:scale-110 border-black border-2 bg-accent3 w-[550px] h-[300px] rounded-[20px] m-4 p-4"
                onclick="showModal('hakdog')">
