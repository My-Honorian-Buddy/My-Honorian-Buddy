...
@endphp
<div class="relative inline-block text-left bw-dropmenu !z-[9999] {{$name}}" tabindex="0">
    ...
    <div class="opacity-0 hidden bw-dropmenu-items  !z-[9999] animate__animated animate__fadeIn animate__faster"
         data-open="0">
        <div @class([
