...
@if($canCrop)
    @once
        <x-bladewind::modal name="cropper-container" size="md" align_buttons="center" backdrop_can_close="false" ok_button_label="Crop">
...
<div class="bw-filepicker-placeholder-{{$cleanName}} space-y-2 flex hidden align-middle py-3">
    <div>
        <x-bladewind::icon name="note-2" class="size-14 rounded-full p-2 bg-black stroke-2 text-black dark:bg-dark-100/50 dark:invert dark:opacity-30"/>
    </div>
