    ...
    @if(!empty($decodedSubject))
        ...
        @endif
            @if($hasBookedSessions)
                <div class="bg-accent2 flex items-center w-full border-b-2 border-black py-2">
                    <div class="bg-accent2 flex items-center w-full h-full  py-2">
                        {{-- modal button --}}
                        <div class="text-white">
                            <div class=" ml-5">
                                <x-bladewind::button 
                                            type="submit" 
                                            class="bg-primary border-2 border-black hover:bg-red-900 text-accent2 font-bold flex justify-items-center"
                                            size="small"
                                            rounded="true"
                                ...
                                @if (Auth::user()->role === 'Tutor')
                                    <x-bladewind.modal
                                        ...
                                        <p class="mx-4 mt-4">Your current session will terminate without payment for the previous meetings you attended. </p><br>
                                ...
                                @elseif (Auth::user()->role === 'Student')
                                    <x-bladewind.modal
                                        ...
                                        <p class="mx-4 mt-4">A notification regarding the cancellation of the session will be delivered to your tutor for confirmation.</p><br>
