...
@if($hasBookedSessions)
    <section class="h-full ">
        ...
        <div class="bg-accent3 h-full rounded-[20px] pb-2 mb-4 shadow-custom-button shadow-black border-black border-2">
            ...
            <div class="grid grid-cols-2 items-center p-4">
                ...
                <div class="flex justify-center">
                    <img src="{{$profile_pic}}" alt="Profile" class="w-[80%] h-[80%] border-4 border-black rounded-lg">
                </div>    
                <!-- profile infos -->
                <div>
...
@else
    <section class="m-4 mt-8 mr-8 max-w-s">
        <div class="bg-[#D9D9D9] rounded-[20px] pb-2 mb-4 shadow-custom-button shadow-black border-black border-2">
            <div class="rounded-t-[20px] text-2xl text-primary text-stroke font-black p-3 border-b-2 border-black">
                @if(Auth::user()->role === 'Student')
                    YOU HAVE NO BUDDYs
                @else
                    YOU HAVE NO STUDENT
