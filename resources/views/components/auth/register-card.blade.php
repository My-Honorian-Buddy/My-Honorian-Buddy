<div class="flex flex-col overflow-hidden justify-center items-center border-black md:flex-row h-screen bg-secondary border-4 rounded-[16px] shadow-custom-button w-4/5 my-24 mx-auto">
    <div class="md:w-1/2 w-full bg-secondary h-full font-poppins rounded-[16px]">
        <div class="flex justify-start items-center h-1/6 w-full lg:w-full md:w-full sm:w-full sm:shrink-0">
            <img src="{{ asset('images/logo.svg') }}" alt="logo" class="m-[5%] lg:w-1/6 xl:w-1/5">
        </div>
    ...
    <div class=" flex flex-col justify-center md:w-1/2 w-full bg-primary p-10 px-20 h-full">
        ...
        <h2 class=" text-secondary lg:text-4xl xl:text-5xl mb-6 [text-shadow:4px_4px_0px_#000000] [-webkit-text-stroke:2px_#000000] font-bold font-poppins"> Create Account </h2>
        <div class="w-full">
            {{ $slot }}
        </div>
