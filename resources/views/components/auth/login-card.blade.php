<div class="overflow-hidden flex flex-col justify-center items-center border-black md:flex-row h-screen bg-secondary border-4 rounded-lg shadow-custom-button w-4/5 my-24 mx-auto">
